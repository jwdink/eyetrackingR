...
fit_int_time_diss = lmer(elog ~ ot1 + ot2 + ot3 + DissBPC:ot1 + DissBPC:ot2 + DissBPC:ot3 + AOI + DissNoBPC + # fixed
                           (1+ot1+ot2+ot3+AOI|Participant) + (1+ot1+ot2+ot3+AOI|Image),                       # random
                     REML = FALSE,
                     data = df_time)
