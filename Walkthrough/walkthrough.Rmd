...
summary(familiar_bootstrapped_intervals, data_options)
```
...
seq_bin = analyze_time_bins(response_time_by_subj, data_options, condition_column = "Target", paired = TRUE, threshold = 3.25)
plot(seq_bin) 


bar = analyze_time_clusters(response_time_by_subj, data_options, condition_column = "Target", 
                            within_subj = TRUE, paired= TRUE, threshold = 3.35, samples=50)
