...
response_time_both_aoi <- make_time_sequence_data(response_window_clean, data_options, time_bin_size = 100, 
                                 predictor_columns = c("Target")
                            )

# visualize time results
plot(response_time_both_aoi, predictor_column = "Target") + 
  theme_light() +
  coord_cartesian(ylim = c(0,1))

response_time <- dplyr::filter(response_time_both_aoi, AOI == "Animate")
```
